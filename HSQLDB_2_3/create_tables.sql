...
CREATE SEQUENCE OACC.OAC_ResourceClassID AS BIGINT INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;

CREATE SEQUENCE OACC.OAC_PermissionID AS BIGINT INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;

CREATE SEQUENCE OACC.OAC_DomainID AS BIGINT INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;

CREATE SEQUENCE OACC.OAC_ResourceID AS BIGINT INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;
